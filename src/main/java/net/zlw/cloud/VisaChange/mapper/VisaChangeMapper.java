...
public interface VisaChangeMapper extends Mapper<VisaChange> {
    ...
    @Select("  select  " +
            ...
            "            v2.state = '0' " +
            "            order by v2.create_time desc ")
    List<VisaChangeListVo> findAllVisaProcessing2(PageVo pageVo);
    ...
    @Select("  select  " +
            ...
            "            (v.compile_time >= #{startTime} or #{startTime} = '') and   " +
            "            (v.compile_time <= #{endTime} or #{endTime} = '') and  " +
            "      (b.visa_status = '3' or b.visa_status = '7' ) and  " +
            "            (  " +
            "            b.cea_num like concat('%',#{keyword},'%') or   " +
            "            b.project_num like concat('%',#{keyword},'%') or  " +
            "            b.project_name like concat('%',#{keyword},'%') or   " +
            ...
            "            v2.state = '0' " +
            "            order by v2.create_time desc ")
    List<VisaChangeListVo> findAllVisaUnsanctioned(PageVo pageVo);
    ...
    @Select("  select  " +
            ...
            "            v2.state = '0' " +
            "            order by v2.create_time desc ")
    List<VisaChangeListVo> findAllVisaProcessing1(PageVo pageVo);
