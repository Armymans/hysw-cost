...
public interface TrackAuditInfoDao extends Mapper<TrackAuditInfo> {
    @Select("select    " +
            ...
            "                   ( CASE tai.outsource  WHEN '0' THEN '是' WHEN '1' THEN '否' END ) AS outsource,  " +
    ...
    @Select("select    " +
            ...
            "                    b.construction_organization like concat  ('%',#{keyword},'%')    " +
            "                    )")
    List<ReturnTrackVo> selectTrackList02(PageVo pageVo);
    ...
    @Select("select    " +
            ...
            "                    b.construction_organization like concat  ('%',#{keyword},'%')    " +
            "                    )")
    List<ReturnTrackVo> selectTrackList4(PageVo pageVo);
    ...
    @Select("select    " +
            ...
            "                    b.construction_organization like concat  ('%',#{keyword},'%')    " +
            "                    )")
    List<ReturnTrackVo> selectTrackList2(PageVo pageVo);
    ...
    @Select("select    " +
            ...
            "                    b.construction_organization like concat  ('%',#{keyword},'%')    " +
            "                    )")
    List<ReturnTrackVo> selectTrackList3(PageVo pageVo);
    ...
    List<ReturnTrackVo> selectTrackList6(PageVo pageVo);
