...
@Data
public class ProgressPaymentInformation {
    /* `id` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '唯一标识',
  ...
  `progress_payment_id` varchar(60) DEFAULT NULL COMMENT '进度款外键id',
